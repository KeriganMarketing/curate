...
<footer id="bot" >
    ...
    <div class="section-wrapper gray-section">
        ...
        <div class="signoff">
            <p id="copyright">&copy; <?php echo date('Y'); ?> <?php echo get_bloginfo(); ?>. <span id="siteby" style="padding: 0 1rem;"><svg version="1.1" id="kma" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height="14" width="20" viewBox="0 0 12.5 8.7" style="enable-background:new 0 0 12.5 8.7;" xml:space="preserve">
